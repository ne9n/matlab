...
H_subplots = 5;
    ...
    sp1(1) = subplot(H_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(SimResults.tout,-1*SimResults.shunt_float,'-k','LineWidth',1,'DisplayName','shunt float')
        plot(SimResults.tout,-1*SimResults.shunt_int16,'--c','LineWidth',2,'DisplayName','shunt int16')
        plot(SimResults.tout,SimResults.Dchg_PL,'-m','LineWidth',2,'DisplayName','Dchg PL')
        plot(SimResults.tout,SimResults.Dchg_contPL_limit,'--g','DisplayName','cont thresh')
        plot(SimResults.tout,SimResults.Dchg_50sPL_limit,'--r','DisplayName','50sec thresh')
        plot(SimResults.tout,SimResults.Dchg_10sPL_limit,'--b','DisplayName','10sec thresh')
        ylabel('amps'); ylim([-10 520])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
    ...
    sp1(2) = subplot(H_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        %yyaxis left; 
        plot(SimResults.tout,SimResults.Dchg_10sPL_timer,'-k','LineWidth',1,'DisplayName','10s tmr')
...
%         yline(cal_Relaxing_neg_thresh_mA,'--b','DisplayName','neg relax thres')
    ...
    sp1(3) = subplot(H_subplots,1,3); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(SimResults.tout,SimResults.Dchg_10sPL_state,'-k','LineWidth',1,'DisplayName','10s state'); 
    ...
    sp1(4) = subplot(H_subplots,1,4); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(SimResults.tout,SimResults.Dchg_50sPL_timer,'-k','LineWidth',1,'DisplayName','50s tmr'); 
    ...
    sp1(5) = subplot(H_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(SimResults.tout,SimResults.Dchg_50sPL_state,'-k','LineWidth',1,'DisplayName','50s state'); 
        %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
        ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
