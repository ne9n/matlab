...
if skip_plots == 0
    % Set axis limits   
       ...
       % min_dcap = min(test_dCap_mAh); max_dcap = max(test_dCap_mAh);
        ...
        %    xlim_Xload_start = 47000; xlim_Xload_stop = 51000;
...
H_subplots = 5;
    ...
    sp1(1) = subplot(H_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,-1*test_signal_20ms(1:test_samples),'-k','LineWidth',1,'DisplayName','shunt float')
        plot(time,-1*SimResults.shunt_int16(1:test_samples),'--c','LineWidth',2,'DisplayName','shunt int16')
        plot(time,SimResults.Dchg_PL(1:test_samples),'-m','LineWidth',2,'DisplayName','Dchg PL')
        plot(time,SimResults.Dchg_contPL_limit(1:test_samples),'--g','DisplayName','cont thresh')
        plot(time,SimResults.Dchg_50sPL_limit(1:test_samples),'--r','DisplayName','50sec thresh')
        plot(time,SimResults.Dchg_10sPL_limit(1:test_samples),'--b','DisplayName','10sec thresh')
    ...
    sp1(2) = subplot(H_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        %yyaxis left; 
        plot(time,SimResults.Dchg_10sPL_timer(1:test_samples),'-k','LineWidth',1,'DisplayName','10s tmr')
...
%         yline(cal_Relaxing_neg_thresh_mA,'--b','DisplayName','neg relax thres')
    ...
    sp1(3) = subplot(H_subplots,1,3); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Dchg_10sPL_state(1:test_samples),'-k','LineWidth',1,'DisplayName','10s state'); 
    ...
    sp1(4) = subplot(H_subplots,1,4); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Dchg_50sPL_timer(1:test_samples),'-k','LineWidth',1,'DisplayName','50s tmr'); 
    ...
    sp1(5) = subplot(H_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Dchg_50sPL_state(1:test_samples),'-k','LineWidth',1,'DisplayName','50s state'); 
        %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
        ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
...
H1_subplots = 5;
    ...
    sp1(1) = subplot(H1_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,test_signal_20ms(1:test_samples),'-k','LineWidth',1,'DisplayName','shunt')
        plot(time,SimResults.Regen_PL(1:test_samples),'-m','LineWidth',2,'DisplayName','Regen PL')
    ...
    sp1(2) = subplot(H1_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        %yline(511,':k','DisplayName','center')
        %yyaxis left; 
        plot(time,SimResults.Regen_10sPL_timer(1:test_samples),'-k','LineWidth',1,'DisplayName','10s tmr')
        %yline(0,':k','DisplayName','0A ref')
        ylabel('msec'); ylim([-500 10500])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
...
%         yline(cal_Relaxing_neg_thresh_mA,'--b','DisplayName','neg relax thres')
    ...
    sp1(3) = subplot(H1_subplots,1,3); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Regen_10sPL_state(1:test_samples),'-k','LineWidth',1,'DisplayName','10s state'); 
        %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
        ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
        ax = gca; ax.YColor = 'k';
        % calc the rounding error: DO NOT COMPARE "NOW" AGAINST PREVIOUS, as this result is precisely the dCap signal
    ...
    sp1(4) = subplot(H1_subplots,1,4); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Regen_50sPL_timer(1:test_samples),'-k','LineWidth',1,'DisplayName','50s tmr'); 
        %plot(SimResults.dCap_uAh_int32/scaler1,'--g','LineWidth',1,'DisplayName','dCap mAh int32');
        ylabel('msec'); ylim([-1000 51000])
        ax = gca; ax.YColor = 'k';
        % calc the rounding error
    ...
    sp1(5) = subplot(H1_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Regen_50sPL_state(1:test_samples),'-k','LineWidth',1,'DisplayName','50s state'); 
        %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
        ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
...
%         ax.YColor = 'b';
    ...
    sp2(2) = subplot(H2_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Xload_enum(1:test_samples),'-k','LineWidth',1,'DisplayName','enum'); 
    ...
    sp2(3) = subplot(H2_subplots,1,3);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Xload_0s_events(1:test_samples),'-k','LineWidth',1,'DisplayName','0sec ev cnt'); 
    ...
    sp2(4) = subplot(H2_subplots,1,4); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Xload_1s_events(1:test_samples),'-k','LineWidth',1,'DisplayName','1sec ev cnt'); 
        ylabel('% soc'); ylim([-10 110])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
...
%         
    sp2(5) = subplot(H2_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time,SimResults.Xload_timer(1:test_samples),'-k','LineWidth',1,'DisplayName','viol tmr');  
     ...
     sp(6) = subplot(H2_subplots,1,6);
        hold on
        yyaxis left; 
        plot(time,-1*SimResults.Xload_peak(1:test_samples),'-k','LineWidth',2,'DisplayName','peak A'); 
