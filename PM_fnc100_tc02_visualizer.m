    ...
    % Set axis limits   
       ...
       % min_dcap = min(test_dCap_mAh); max_dcap = max(test_dCap_mAh);
        ...
        % Discharge Power Map start-stop xlim
            xlim_Dchg_start = 1; xlim_Dchg_stop = test_samples;
        % Regen Power Map start-stop xlim
            xlim_Regen_start = 1; xlim_Regen_stop = test_samples;
        % Excessive Discharge start-stop xlim
            xlim_Xdchg_start = 1; xlim_Xdchg_stop = test_samples;
        % Excessive Regen start-stop xlim
            xlim_Xregen_start = 1; xlim_Xregen_stop = test_samples;
...
H_Dchg_subplots = 5;
    ...
    sp_Dchg(1) = subplot(H_Dchg_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Dchg_start:xlim_Dchg_stop),-1*SimResults.shunt(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','shunt')
...
%         yline(cal_Relaxing_neg_thresh_mA,'--b','DisplayName','neg relax thres')
    ...
    sp_Dchg(5) = subplot(H_Dchg_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        str_title = "RECOMMENDED DISCHARGE POWER MAP - ";
        str_sgtitle = str_title + str_app + newline + str_TestConditions;

        sgtitle(str_sgtitle);
        linkaxes(sp_Dchg,'x')
        
        fig_type = "RecDchgLimit_";
        fig_app = str_app + "_";
        fig_conditions = str_soc1 + "soc_" + str_cellT1 + "degC";
        figname = fig_type + fig_app + fig_conditions;
        savefig(figname)
...
%         yline(cal_Relaxing_neg_thresh_mA,'--b','DisplayName','neg relax thres')
    ...
    sp_Regen(5) = subplot(H1_Regen_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        str_title = "RECOMMENDED REGEN POWER MAP - ";
        str_sgtitle = str_title + str_app + newline + str_TestConditions;

        sgtitle(str_sgtitle);
        linkaxes(sp_Regen,'x')

        fig_type = "RecRegenLimit_";
        fig_app = str_app + "_";
        fig_conditions = str_soc1 + "soc_" + str_cellT1 + "degC";
        figname = fig_type + fig_app + fig_conditions;
        savefig(figname)
...
H_Xdchg_subplots = 7;
    ...
    sp_Xdchg(1) = subplot(H_Xdchg_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        grid minor
        xlabel('seconds'); 
        title('Excessive Discharge Test Current')
        legend('show','Location','northeast')
        box on
    ...
    sp_Xdchg(2) = subplot(H_Xdchg_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        title('Excessive Discharge Amps State & Diagnostic enumerations')
...
%       
    sp_Xdchg(5) = subplot(H_Xdchg_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        grid minor
        xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
        title('Number of PROTECT events')
        legend('show','Location','west')
        box on
    ...
    sp_Xdchg(6) = subplot(H_Xdchg_subplots,1,6); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        grid minor
        xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
        title('Excessive Discharge Amps Violation Durations')
        legend('show','Location','west')
        box on
     ...
     sp_Xdchg(7) = subplot(H_Xdchg_subplots,1,7);
        ...
        grid minor
        xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
        title('Peak Current at Excessive Discharge Amps Fault and Protect Events')
        legend('show','Location','west')
        box on
        %xlim([xlim_Xstart xlim_Xstop])                 
        
        str_title = "EXCESSIVE DISCHARGE CURRENT MONITORING, DIAGNOSTICS & METRICS - ";
        str_sgtitle = str_title + str_app + newline + str_TestConditions;

        sgtitle(str_sgtitle);
        linkaxes(sp_Xdchg,'x')

        fig_type = "XDchgLimit_";
        fig_app = str_app + "_";
        fig_conditions = str_soc1 + "soc_" + str_cellT1 + "degC";
        figname = fig_type + fig_app + fig_conditions;
        savefig(figname)
...
%       
    ...
    sp_Xregen(6) = subplot(H_Xregen_subplots,1,6); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
     ...
     sp_Xregen(7) = subplot(H_Xregen_subplots,1,7);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        str_title = "EXCESSIVE REGEN CURRENT MONITORING, DIAGNOSTICS & METRICS - ";
        str_sgtitle = str_title + str_app + newline + str_TestConditions;

        sgtitle(str_sgtitle);
        linkaxes(sp_Xregen,'x')

        fig_type = "XRegenLimit_";
        fig_app = str_app + "_";
        fig_conditions = str_soc1 + "soc_" + str_cellT1 + "degC";
        figname = fig_type + fig_app + fig_conditions;
        savefig(figname)
