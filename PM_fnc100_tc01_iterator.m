...
% load TestHarness model & harness-related variables that do not change during one Test Case
    TestHarness = file_tc01_harness_model;
...
switch tc_iter_current
    ...
    case 2 % Test case iteration 2
        ...
        % -----------------------------------------------------
        % STEP 1: adjust TestHarness or its parameters as needed
            %TestHarness = 'PM_fnc1000_TestHarness';
        ...
        % STEP 3:
            ...
            %run('PM_fnc100_tc01_iter02_signal_builder.m')
        % STEP 4:
    ...
    case 5 % Test case iteration 5: 
        ...
        % STEP 2 % adjust specific cals loaded in iter01, else load a different init_cal file)
        % STEP 3
            %load('appdata_concrete_trowel.mat')
        % STEP 4
    ...
    case 6 % Test case iteration 6
        ...
        % STEP 2 % adjust specific cals loaded in iter01, else load a different init_cal file)
        % STEP 3
            %load('appdata_rail_saw.mat')
        % STEP 4

     case 7 % Test case iteration 6
        % PURPOSE:  Verify ...
        % -----------------------------------------------------
        % STEP 1
        % STEP 2 % adjust specific cals loaded in iter01, else load a different init_cal file)
        % STEP 3
            %load('appdata_utv_0p50_scale.mat')
        % STEP 4

    case 8 % Test case iteration 6
        % PURPOSE:  Verify ...
        % -----------------------------------------------------
        % STEP 1
        % STEP 2 % adjust specific cals loaded in iter01, else load a different init_cal file)
        % STEP 3
            %load('appdata_ztr_0p50_scale.mat')
        % STEP 4

    case 9 % Test case iteration 6
        % PURPOSE:  Verify ...
        % -----------------------------------------------------
        % STEP 1
        % STEP 2 % adjust specific cals loaded in iter01, else load a different init_cal file)
        % STEP 3
            %load('appdata_ztr_0p75_scale.mat')
        % STEP 4
