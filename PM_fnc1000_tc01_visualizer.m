...
H2_subplots = 6;
    ...
    sp2(1) = subplot(H2_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),test_signal(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','shunt')
...
%         ax.YColor = 'b';
    ...
    sp2(2) = subplot(H2_subplots,1,2);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_enum(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','enum'); 
    ...
    sp2(3) = subplot(H2_subplots,1,3);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_0s_events(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','0sec ev cnt'); 
    ...
    sp2(4) = subplot(H2_subplots,1,4); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_1s_events(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','1sec ev cnt'); 
        ylabel('% soc'); ylim([-10 110])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
...
%         
    sp2(5) = subplot(H2_subplots,1,5); % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_timer(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','viol tmr');  
     ...
     sp(6) = subplot(H2_subplots,1,6);
        hold on
        yyaxis left; 
        plot(time(xlim_Xload_start:xlim_Xload_stop),-1*SimResults.Xload_peak(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',2,'DisplayName','peak A'); 
