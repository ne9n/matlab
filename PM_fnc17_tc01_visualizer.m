...
fig_pos_H1 = [-1100,1250,1500,1100]; %[-1750,1250,1500,1100];  % [1800,900,1400,1200];
    ...
    % Set axis limits   
       ...
       % min_dcap = min(test_dCap_mAh); max_dcap = max(test_dCap_mAh);
        ...
        %Xloading start-stop xlim
            xlim_Xdchg_start = 47000; xlim_Xdchg_stop = 50700;
...
H_subplots = 1;
    ...
    sp1(1) = subplot(H_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),test_signal(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','shunt')
        plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),SimResults.PLout(xlim_Dchg_start:xlim_Dchg_stop),'-m','LineWidth',2,'DisplayName','Dchg PL')
        yline(-100,'--g','DisplayName','cont thresh')
        yline(-157,'--r','DisplayName','50sec limit')
        yline(-200,'--b','DisplayName','10sec limit')
        ylabel('amps'); ylim([-250 20])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
        ...
        title('Ratelimiter during Discharge Current Limit')
...
%         %yyaxis left; 
%         plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),SimResults.Dchg_10sPL_timer(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','10s tmr')
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),SimResults.Dchg_10sPL_state(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','10s state'); 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),SimResults.Dchg_50sPL_timer(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','50s tmr'); 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Dchg_start:xlim_Dchg_stop),SimResults.Dchg_50sPL_state(xlim_Dchg_start:xlim_Dchg_stop),'-k','LineWidth',1,'DisplayName','50s state'); 
%         %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
%         ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
%         ax = gca; ax.YColor = 'k';
%         %yyaxis right; 
...
H1_subplots = 1;
    ...
    sp1(1) = subplot(H1_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time_s(xlim_Regen_start:xlim_Regen_stop),test_signal(xlim_Regen_start:xlim_Regen_stop),'-k','LineWidth',1,'DisplayName','shunt')
        plot(time_s(xlim_Regen_start:xlim_Regen_stop),SimResults.PLout(xlim_Regen_start:xlim_Regen_stop),'-m','LineWidth',2,'DisplayName','Regen PL')
        yline(29,'--g','DisplayName','cont thresh')
        yline(58,'--r','DisplayName','50sec limit')
        yline(84,'--b','DisplayName','10sec limit')
        ylabel('amps'); ylim([0 250])
        ax = gca; ax.YColor = 'k';
        %yyaxis right; 
        %plot(SimResults.cc_cap_prev_uAh_uint32,'--c','LineWidth',1,'DisplayName','Pcap now uint32')
        %plot(SimResults.cc_cap_now_mAh_simout - 100 ,'-b','LineWidth',2,'DisplayName','Pcap now simout')
        ...
        grid minor
        xlabel('seconds'); %xlim([xlim_Regen_start xlim_Regen_stop])
        title('Ratelimiter during Regen Current Limit')
        legend('show','Location','northeast')
        box on
...
%         %yline(511,':k','DisplayName','center')
%         %yyaxis left; 
%         plot(time_s(xlim_Regen_start:xlim_Regen_stop),SimResults.Regen_10sPL_timer(xlim_Regen_start:xlim_Regen_stop),'-k','LineWidth',1,'DisplayName','10s tmr')
%         %yline(0,':k','DisplayName','0A ref')
%         ylabel('msec'); ylim([-500 10500])
%         ax = gca; ax.YColor = 'k';
%         %yyaxis right; 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Regen_start:xlim_Regen_stop),SimResults.Regen_10sPL_state(xlim_Regen_start:xlim_Regen_stop),'-k','LineWidth',1,'DisplayName','10s state'); 
%         %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
%         ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
%         ax = gca; ax.YColor = 'k';
%         % calc the rounding error: DO NOT COMPARE "NOW" AGAINST PREVIOUS, as this result is precisely the dCap signal
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Regen_start:xlim_Regen_stop),SimResults.Regen_50sPL_timer(xlim_Regen_start:xlim_Regen_stop),'-k','LineWidth',1,'DisplayName','50s tmr'); 
%         %plot(SimResults.dCap_uAh_int32/scaler1,'--g','LineWidth',1,'DisplayName','dCap mAh int32');
%         ylabel('msec'); ylim([-1000 51000])
%         ax = gca; ax.YColor = 'k';
%         % calc the rounding error
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Regen_start:xlim_Regen_stop),SimResults.Regen_50sPL_state(xlim_Regen_start:xlim_Regen_stop),'-k','LineWidth',1,'DisplayName','50s state'); 
%         %plot(SimResults.cc_cap_now_mAh_dfloat_fxp_calc,'--g','LineWidth',1,'DisplayName','Cap now mAh dfloat fxp calc'); 
%         ylabel('enum'); ylim([-0.25 6.26]) %m_min_cap ylim_max_cap])
%         ax = gca; ax.YColor = 'k';
%         %yyaxis right; 
...
% %     
% % % ============================================================================================
% %% PLOT EXCESSIVE CURRENTS OUTPUTS
...
H2_subplots = 1;
    ...
    sp2(1) = subplot(H2_subplots,1,1);  % <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        hold on
        %yyaxis left; 
        plot(time_s(xlim_Xdchg_start:xlim_Xdchg_stop),test_signal(xlim_Xdchg_start:xlim_Xdchg_stop),'-k','LineWidth',1,'DisplayName','shunt')
        plot(time_s(xlim_Xdchg_start:xlim_Xdchg_stop),SimResults.PLout(xlim_Xdchg_start:xlim_Xdchg_stop),'-m','LineWidth',2,'DisplayName','Xdchg PL')
...
%         ax.YColor = 'b';
        %xlim([xlim_Xload_start xlim_Xload_start])
         grid minor
        xlabel('seconds'); 
        title('Ratelimiter during Excessive Discharge Test Current')
        legend('show','Location','northeast')
        box on
% 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_enum(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','enum'); 
...
%         ylabel('enum'); ylim([-0.25 3.25]) 
%         %ax = gca; ax.YColor = 'k';
%         %yyaxis right; plot(SimResults.cell_V_dfloat,'-r','LineWidth',0.5,'DisplayName','cellV dfloat'); 
%         %ylabel('enum'); %ylim([-10 10])
%         %ax = gca; ax.YColor = 'r'; 
%         grid minor
%         xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
%         title('Excessive Loading state enumerations')
%         subtitle('(0 = no violations, 1 = 0 sec duration violation, 2 = 1 sec duratino violation, 3 = full duration violation)')
%         legend('show','Location','northeast')
%         box on
% 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_0s_events(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','0sec ev cnt'); 
...
%         grid minor
%         xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
%         title('Number of 0 second Excessive Loading Violation events')
%         legend('show','Location','northeast')
%         box on
%              
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_1s_events(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','1sec ev cnt'); 
%         ylabel('% soc'); ylim([-10 110])
%         ax = gca; ax.YColor = 'k';
%         %yyaxis right; 
...
%         hold on
%         %yyaxis left; 
%         plot(time_s(xlim_Xload_start:xlim_Xload_stop),SimResults.Xload_timer(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',1,'DisplayName','viol tmr');  
%         yline(3000,'--r','LineWidth',2,'DisplayName','dur max')
%         %xline(trans(1,1),':r','LineWidth',1,'DisplayName','Dchg2Relax');
%         ylabel('msec');  ylim([-100 3100])
%         ax = gca; ax.YColor = 'k';
%         %yyaxis right; 
...
%         grid minor
%         xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
%         title('Excessive Loading Violation Durations')
%         legend('show','Location','northeast')
%         box on
% 
%      sp(6) = subplot(H2_subplots,1,6);
%         hold on
%         yyaxis left; 
%         plot(time_s(xlim_Xload_start:xlim_Xload_stop),-1*SimResults.Xload_peak(xlim_Xload_start:xlim_Xload_stop),'-k','LineWidth',2,'DisplayName','peak A'); 
%         ylabel('Capacity (mAh)'); ylim([-200 5])
%         ax = gca; ax.YColor = 'k';
% %         yyaxis right; 
...
%         grid minor
%         xlabel('seconds'); %xlim([xlim_Xload_start xlim_Xload_stop])
%         title('Peak Current at Excessive Loading Protection')
%         legend('show','Location','northeast')
%         box on
%         %xlim([xlim_Xstart xlim_Xstop])                 
%         sgtitle('EXCESSIVE LOADING DETECTION');
%         linkaxes(sp2,'x')
% % 
